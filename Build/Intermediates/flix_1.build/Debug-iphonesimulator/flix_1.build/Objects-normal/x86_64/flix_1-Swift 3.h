...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flix_1",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6flix_111AppDelegate")
...
SWIFT_CLASS("_TtC6flix_113MovieGridCell")
...
@interface MoviesViewController (SWIFT_EXTENSION(flix_1)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC6flix_113SceneDelegate")
...
SWIFT_CLASS("_TtC6flix_117webViewController")
@interface webViewController : UIViewController <WKUIDelegate>
@property (nonatomic, weak) IBOutlet WKWebView * _Null_unspecified trailerView;
- (void)loadView;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
